...
def enrich_foot_route(route):
    ...
    route['waypoints'] = [
        {
            "waypoint": get_eco_route([tuple(route['waypoints'][0].values()),  transfers['start']['base']], vehicle="foot"),
            "color": FOOT_COLOR,
        },
        {
        ...
        {
            "waypoint": get_eco_route([transfers['end']['base'], tuple(route['waypoints'][-1].values())], vehicle="foot")
            "color": FOOT_COLOR,
        },
    ]
